...
(function( $ ){
  ...
  var methods={
      ...
      reload : function(options) {
                  ...
                  var a=inputid.split('-');           
                  var inputarr=arrayinput[a[0]][a[1]];
                  ...
                  $.each(list[0],function(i,val){
                      dropdown+='<li class="'+((arrayinput[a[0]][a[1]].indexOf(i)===-1) ? '' : 'disabled')+'"><a href="#" data-id="'+i+'">'+val+'</a></li>';
                  });
                  ...
                  $("#dropdown-"+inputid+" li>a").on("click",function(){
                      ...
                      if (arrayinput[a[0]][a[1]].indexOf(id)==-1) {
                          arrayinput[a[0]][a[1]].push(id);
                          var value='{'+arrayinput[a[0]][a[1]].join(',')+'}';
                          $(elem).val(value);
                  ...
                  $(links).on("click",function(i){
                        ...
                        arrayinput[a[0]][a[1]].splice( arrayinput[a[0]][a[1]].indexOf(id),1);
                        var value='{'+arrayinput[a[0]][a[1]].join(',')+'}';
                        $(elem).val(value);
                        $(elem).kotArrayInput('reload');
                    });
